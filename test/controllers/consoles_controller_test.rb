...
class ConsolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create console" do
    assert_difference("Console.count") do
      post consoles_url, params: { console: { kind: @console.kind, name: @console.name, purchase_date: @console.purchase_date } }
    end
  ...
  test "should update console" do
    patch console_url(@console), params: { console: { kind: @console.kind, name: @console.name, purchase_date: @console.purchase_date } }
